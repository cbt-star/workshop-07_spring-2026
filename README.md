...
The rendered .pdf for the abalone linear model is [here](https://github.com/cbt-star/workshop-07_spring-2026/blob/main/code/abalone-example.pdf).

The rendered .pdf for the temperature linear model is [here](https://github.com/cbt-star/workshop-07_spring-2026/blob/main/code/sonadora-temperature-example.pdf).